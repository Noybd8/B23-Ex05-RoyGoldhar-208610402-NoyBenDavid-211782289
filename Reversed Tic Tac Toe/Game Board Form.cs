...
namespace Reversed_Tic_Tac_Toe
{
    public class GameBoardForm : Form
    {
        ...
        private const int k_FormHeight = 400;
        ...
        private readonly Font r_LabelsFont = new Font("Microsoft Sans Serif", 10);
        ...
        private void createButtonOnBoard(int i_Row, int i_Col, int i_SpotSize)
        {
            ...
            m_Board[i_Col, i_Row].BackColor = this.BackColor;
            m_Board[i_Col, i_Row].FlatStyle = FlatStyle.Popup;
        ...
        private void initLabel(out Label o_Label, Point i_Location)
        {
            o_Label = new Label();
